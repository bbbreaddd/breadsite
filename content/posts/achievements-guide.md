...
date = 2025-12-22T11:35:43-08:00
draft = false
+++

# Pirated Games Achievement Guide
-> Here is a guide on how to see achievements you've unlocked with pirated games using Achievement Watcher and Goldberg. Achievement Watcher can also do achievement notifications, clips, and screenshots to make it seem more official. This is my personal method, and it's been pretty reliable. While it might seem like a lot due to the pictures and number of steps, I just tried to be as specific as possible. <-
!!! warning Warning
	- Requires a Steam account with at least $5 spent on it. You can check here if your account will work https://steamcommunity.com/dev/apikey
!!! info Things to Know:
...
!!! info You don't need to choose the folder where the .exe is located. Just choose the main folder for the game.
...
`Achievement.Watcher.Setup.x.x.xx.exe`
